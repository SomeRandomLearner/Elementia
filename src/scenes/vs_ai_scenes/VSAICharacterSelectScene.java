...
public class VSAICharacterSelectScene extends JPanel {
    ...
    public VSAICharacterSelectScene(Elementia frame) {
        this.frame = frame;
        ...
        card.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (!player1HasChosen) {
                    ...
                    titleLabel.setText("SELECT AI CHARACTER");
    ...
    private void initBottom() {
        ...
        confirmButton.addActionListener(e -> {
            ...
            frame.getVSAIBattle().setBattleLogic(battleLogic);
            frame.showScreen(Scenes.VS_AI_STAGE_SELECT);
        });

        JButton clearButton = Utility.createStyledButton(
                "CLEAR",
                new Color(60, 60, 120).brighter(),
                new Color(40, 40, 80).darker()
        );
